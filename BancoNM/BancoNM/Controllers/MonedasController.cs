...
namespace BancoNM.Controllers
{
    public class MonedasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idMoneda,descripcion")] Monedas monedas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idMoneda,descripcion")] Monedas monedas)
        {
            if (ModelState.IsValid)
            {
