...
namespace BancoNM.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idDepartamento,descripcion")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idDepartamento,descripcion")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
